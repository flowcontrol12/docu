...
![image-20221229115617870](assets/image-20221229115617870.png)
...
![image-20221229121821226](assets/image-20221229121821226.png)
...
![image-20221229122428651](assets/image-20221229122428651.png)
...
![image-20221229135156083](assets/image-20221229135156083.png)
...
![image-20221230112417154](assets/image-20221230112417154.png)
...
The reference point default calculates the metric's value for the period specified in the **Time & Input filters** section. You can shift the time range by a set amount of time using the **Time shift** field - ![image-20221202110131562](assets/image-20221202110131562.png).
...
- **Color** - threshold color on the chart
  ...
  ![image-20221230115229850](assets/image-20221230115229850.png)

- **Range area** - two values are determined - a "tunnel" is created between them on the graph

   ![image-20221230120530174](assets/image-20221230120530174.png)
...
![image-20221230121046776](assets/image-20221230121046776.png)
...
![image-20221230122736718](assets/image-20221230122736718.png)



Available by clicking ![image-20221202111441566](assets/image-20221202111441566.png).

![image-20221230122258898](assets/image-20221230122258898.png)
...
![image-20230103163012408](assets/image-20230103163012408.png)

![image-20230103163044357](assets/image-20230103163044357.png)
...
- **Range area** - two values are determined - a "tunnel" is created between them on the graph
   ...
   - **Bottom deviation(%)** - percentage deviation for the ceil calculated value
     ...
     ![image-20230103163325273](assets/image-20230103163325273.png)

     ![image-20230103163353132](assets/image-20230103163353132.png)
...
![image-20221230123343092](assets/image-20221230123343092.png)
...
![image-20221228124636648](assets/image-20221228124636648.png)
...
![image-20221228124432832](assets/image-20221228124432832.png)

![image-20221228124157439](assets/image-20221228124157439.png)
...
![image-20221228124901736](assets/image-20221228124901736.png)
...
![image-20221228121518141](assets/image-20221228121518141.png)
...
![image-20221228125102434](assets/image-20221228125102434.png)

:::info
To see how these widget types and configuration options are applied in practice, refer to the example in the [Graph Examples](/Examples/Graph-Examples) section. The concepts described - including graph configuration, parameter customization, and visualization behaviors - are demonstrated in that scenario, providing a practical reference for implementing visual components.
:::
...
![image-20221228120701518](assets/image-20221228120701518.png)
...
![image-20221228121102726](assets/image-20221228121102726.png)
...
![image-20221228125218814](assets/image-20221228125218814.png)
...
![image-20221228120916410](assets/image-20221228120916410.png)
...
![image-20221228120338299](assets/image-20221228120338299.png)
...
![image-20221228121005219](assets/image-20221228121005219.png)
...
![image-20221228125420498](assets/image-20221228125420498.png)
...
![image-20221228125536427](assets/image-20221228125536427-2228583.png)

![image-20221228125628783](assets/image-20221228125628783.png)
...
![image-20221228121251370](assets/image-20221228121251370.png)
...
![image-20221228115844389](assets/image-20221228115844389.png)
...
![image-20230913121522281](assets/image-20230913121522281.png)
...
![Pivot Table](assets/pivot-table.png)
