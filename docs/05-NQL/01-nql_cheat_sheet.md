...
| **top/rare** | top {field} [by {field_name}, [{field_name1},…]] [limit={number}] [others=true/false] [maxBuckets={number}] \<br /><br />\| rare {field} [by {field_name, [field_name1, ….]}] [limit={number}] [others=true/false] [maxBuckets={number}] | Returns the {limit} most frequent top/rare values of the expression. | `src stream="netflow" |  top clientIp limit=2` |
