...
A detailed description of the individual elements of the Permissions section can be found at the end of this document. 
...
| Permission        | Backend Operation                                            | GUI Element                                            |
| ----------------- | ------------------------------------------------------------ | ------------------------------------------------------ |
| View              | Acquisition of the list of network devices                   | Network Interfaces                                     |
| View              | Acquisition of information on the network device             | Network Interfaces                                     |
| View              | Acquisition of the list of network connections               | Network Interfaces                                     |
| View              | Acquisition of information on the active network connection  |                                                        |
| View              | Acquisition of information on the network connection.        |                                                        |
| View              | Acquisition of information on the IPv4 configuration.        |                                                        |
| View              | Acquisition of information on the IPv6 configuration.        |                                                        |
| View              | Acquisition of information on the DHCP configuration.        |                                                        |
| View              | Acquisition of lists of services                             | Services                                               |
| View              | Acquisition of information on a service                      |                                                        |
| View              | Acquisition of information on system metrics                 | CPU, Memory usage, OS Disk Drive, Datastore Disk Drive |
| View              | Acquisition of system logs                                   | System logs                                            |
| View              | Acquisition of information on the NTP service configuration  | Uptime                                                 |
| View, Edit        | Configuration of the Flowforward service                     |                                                        |
| View, Edit        | Configuration of the proxy service                           |                                                        |
| View, Edit        | Configuration of disks                                       |                                                        |
| View, Edit        | Configuration of the SNMP service                            |                                                        |
| View, Edit        | Management of certificates                                   |                                                        |
| View, Edit        | Management of the Tcp Dump service                           |                                                        |
|                   |                                                              |                                                        |
| Add, Delete, Edit | Addition/Deletion/Activation/Deactivation of a network connection | Network Interfaces                                     |
|                   |                                                              |                                                        |
| Edit              | Change of user's password                                    |                                                        |
| Edit              | Configuration of a network connection                        |                                                        |
| Edit              | Activation/Deactivation of a service                         | Services, `Stop`, `Restart` buttons                    |
| Edit              | System restart                                               | `Restart` button                                       |
| Edit              | System shutdown                                              | `ShutDown` button                                      |
| Edit              | Acquisition of system logs in a ZIP file                     | System logs                                            |
| Edit              | Configuration of NTP service                                 | Uptime                                                 |
|                   |                                                              |                                                        |
| Delete            | Deletion of NTP service                                      | Uptime                                                 |
|                   |                                                              |                                                        |
...
| Permission | Backend Operation                             |
| ---------- | --------------------------------------------- |
| Edit       | Addition of data to the notification pipeline |
...
| Permission                               | Backend Operation                                |
| ---------------------------------------- | ------------------------------------------------ |
| View                                     | Acquisition of netflow sources                   |
| View, License: 'Netflow', 'Visibility'   | Creation of a pre-aggregate                      |
| View, License: 'Netflow', 'Visibility'   | Acquisition of fields definitions                |
| View, License: 'Netflow', 'Visibility'   | Acquisition of selected field definition         |
| View, License: 'Netflow', 'IPS'          | Acquisition of isp/mpls mapping                  |
| View, License: 'Netflow', 'Visibility'   | Acquisition of information on templates          |
| View, License: 'Netflow', 'Visibility'   | Acquisition of information on fields occurrences |
| View, License: 'Netflow', 'Visibility'   | Acquisition of information on the strategy       |
| View, License: 'Netflow', 'Visibility'   | Acquisition of information on the type of fields |
| View, License: 'Netflow', 'Visibility'   | Acquisition of the field value                   |
| View, License: 'Netflow', 'IPS'          | Acquisition of isp/mpls                          |
|                                          |                                                  |
| Add                                      | Adding of a netflow source                       |
| Add, License: 'Netflow', 'Visibility'    | Creation of a field definition                   |
|                                          |                                                  |
| Edit                                     | Editing of a netflow source                      |
| Edit, License: 'Netflow', 'Visibility'   | Editing of a field definition                    |
| Edit, License: 'Netflow', 'IPS'          | Editing of isp/mpls                              |
|                                          |                                                  |
| Delete                                   | Deletion of a netflow source                     |
| Delete, License: 'Netflow', 'Visibility' | Deletion of a field definition                   |
|                                          |                                                  |
...
| Permission | Backend Operation            |
| ---------- | ---------------------------- |
| View       | Acquisition of SFlow sources |
|            |                              |
| Add        | Creation of an SFlow source  |
|            |                              |
| Edit       | Editing of an SFlow source   |
|            |                              |
| Delete     | Deletion of an SFlow source  |
...
Access to ==Secirut/Security== configuration and viewing the audit logs.
...
| Delete     | Deletion of ==aggregation (czy tu nie miała być konfiguracja?)==. Button: `Delete` (![menu master](assets_02-User%20Roles_/button_delete.png)) |
